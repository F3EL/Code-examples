...
export const PROGRAM_ID = new PublicKey("5AQk18j1vXE8QRYqKP57xkyRxdq62KHgMVMDfuJf1Y3c");
export const METADATA_PROGRAM_ID = "metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s";

export const USDC_MINT = "EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v";
export const USDC_DECIMALS = 6;

export const FEEL_MINT = "FEELeKVxHtsHHvu1ARySjETxnJMKbLC6wHCaMD68ipiR";
export const FEEL_DECIMALS = 9;
